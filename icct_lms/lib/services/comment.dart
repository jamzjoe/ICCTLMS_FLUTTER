...
class CommentService {
  Future createComment(String postID, String message, String name,
  ...
  Future incrementHeart(String postID, String name, String userID,
      String userType, String isHeart) async {
    DocumentReference<Map<String, dynamic>> reference = FirebaseFirestore
        .instance
        .collection('Post')
        .doc(postID)
