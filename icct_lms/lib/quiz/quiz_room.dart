...
class QuizRoom extends StatefulWidget {
  const QuizRoom({Key? key, required this.title, required this.quizzes})
      : super(key: key);
  final String title;
      ...
      child: Scaffold(
        ...
        body: isSubmit
            ? Done(
                ...
                score: widget.quizzes.length.toString(),
                    ...
                    Expanded(
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Text(
                            'Quiz ${quizIndex + 1} out of ${widget.quizzes.length}',
                        ...
                        Questions(
                            ...
                            questions: widget.quizzes[quizIndex]['Question']
                                .toString()),
                        const SizedBox(
                          height: 20,
                        ),
                        ...(widget.quizzes[quizIndex]['answers']
                                as List<String>)
                            .map((e) => Answers(choices: e, answered: answered))
                            .toList()
                      ],
                    )),
                    quizIndex + 1 == widget.quizzes.length
                        ? SizedBox(
