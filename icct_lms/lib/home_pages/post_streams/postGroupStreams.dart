...
class PostGroupStreams extends StatefulWidget {
  const PostGroupStreams({Key? key, required this.widget}) : super(key: key);
  final HomeScreen widget;

  @override
  State<PostGroupStreams> createState() => _PostGroupStreamsState();
}

List<PostModel> searchQuery = [];
final _searchController = TextEditingController();

class _PostGroupStreamsState extends State<PostGroupStreams> {
  @override
