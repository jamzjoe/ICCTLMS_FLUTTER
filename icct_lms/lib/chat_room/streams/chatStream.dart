...
class _ChatStreamState extends State<ChatStream> {
  ...
  Widget build(BuildContext context) {
    // print('TeacherID'+widget.widget.clickID);
    // print('UserID'+widget.widget.userID);
    return Column(
        ...
        children: [
          ...
          Container(
              padding:
                  const EdgeInsets.only(top: 0, right: 10, left: 10, bottom: 5),
              child: Card(
  ...
  Stream<List<ChatModel>?> readChat() => FirebaseFirestore.instance
      .collection('Chat')
      .doc(widget.widget.userType == 'Teacher'
          ? widget.widget.userID
          : widget.widget.clickID)
      .collection(widget.widget.userType == 'Student'
          ? widget.widget.userID
          : widget.widget.clickID)
